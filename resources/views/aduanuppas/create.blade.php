        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start fw-bold">
                    Hantar Laporan Kerosakan Fizikal (UPPA)
                </div>
                @can('edit-aduanuppa')
                <div class="float-end">
            ...
            <div class="card-body">
                <form action="{{ route('aduanuppas.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('nama_pelapor') is-invalid @enderror" id="nama_pelapor" name="nama_pelapor" value="{{ Auth::check() ? Auth::user()->name : '' }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('jawatan_pelapor') is-invalid @enderror" id="jawatan_pelapor" name="jawatan_pelapor" value="{{ Auth::check() ? Auth::user()->jawatan.' '.Auth::user()->gred : '' }}" >
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="email" class="form-control @error('email_pelapor') is-invalid @enderror" id="email_pelapor" name="email_pelapor" value="{{ Auth::check() ? Auth::user()->email : '' }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('phone_pelapor') is-invalid @enderror" id="phone_pelapor" name="phone_pelapor" value="{{ Auth::check() ? Auth::user()->no_telefon : '' }}">
