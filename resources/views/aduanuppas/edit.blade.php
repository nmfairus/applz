...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('aduanuppas.update', $aduanuppa->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <select class="form-select @error('kategori_aduan') is-invalid @enderror" id="kategori_aduan" name="kategori_aduan" value="{{ $aduanuppa->kategori_aduan }}">
                            <option value="{{ $aduanuppa->kategori_aduan }}">{{ $aduanuppa->kategori_aduan }}</option>
                            @foreach ($kategoriaduanuppa as $nama)
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <select class="form-select @error('jenis_aset') is-invalid @enderror" id="jenis_aset" name="jenis_aset" value="{{ $aduanuppa->jenis_aset }}">
                            <option value="{{ $aduanuppa->jenis_aset }}">{{ $aduanuppa->jenis_aset }}</option>
                            @foreach ($jenisasetuppa as $nama)
                                <option value="{{ $nama }}" @selected(old('nama') == $nama)>
                                    {{ $nama }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <select class="form-select @error('tahap_kerosakan') is-invalid @enderror" id="tahap_kerosakan" name="tahap_kerosakan" value="{{ $aduanuppa->tahap_kerosakan }}">
                        <option value="{{ $aduanuppa->tahap_kerosakan }}">{{ $aduanuppa->tahap_kerosakan }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <option value="{{ $aduanuppa->lokasi_utama_kerosakan }}">{{ $aduanuppa->lokasi_utama_kerosakan }}</option>
                            @foreach ($lokasiutamauppa as $nama)
                                <option value="{{ $nama }}" @selected(old('nama') == $nama)>
                                    {{ $nama }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('lokasi_terperinci_kerosakan') is-invalid @enderror" id="lokasi_terperinci_kerosakan" name="lokasi_terperinci_kerosakan" value="{{ $aduanuppa->lokasi_terperinci_kerosakan }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('no_siri') is-invalid @enderror" id="no_siri" name="no_siri" value="{{ $aduanuppa->no_siri }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('pengguna_terakhir') is-invalid @enderror" id="pengguna_terakhir" name="pengguna_terakhir" value="{{ $aduanuppa->pengguna_terakhir }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('nama_pelapor') is-invalid @enderror" id="nama_pelapor" name="nama_pelapor" value="{{ $aduanuppa->nama_pelapor }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="email" class="form-control @error('email_pelapor') is-invalid @enderror" id="email_pelapor" name="email_pelapor" value="{{ $aduanuppa->email_pelapor }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('phone_pelapor') is-invalid @enderror" id="phone_pelapor" name="phone_pelapor" value="{{ $aduanuppa->phone_pelapor }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('jawatan_pelapor') is-invalid @enderror" id="jawatan_pelapor" name="jawatan_pelapor" value="{{ $aduanuppa->jawatan_pelapor }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('perihal_kerosakan') is-invalid @enderror" id="perihal_kerosakan" name="perihal_kerosakan">{{ $aduanuppa->perihal_kerosakan }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="date" class="form-control @error('tarikh_kerosakan') is-invalid @enderror" id="tarikh_kerosakan" name="tarikh_kerosakan" value="{{ $aduanuppa->tarikh_kerosakan }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="date" class="form-control @error('tarikh_laporan') is-invalid @enderror" id="tarikh_laporan" name="tarikh_laporan" value="{{ $aduanuppa->tarikh_laporan }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('status_pembaikan') is-invalid @enderror" id="status_pembaikan" name="status_pembaikan" value="{{ $aduanuppa->status_pembaikan }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('anggaran_kos') is-invalid @enderror" id="anggaran_kos" name="anggaran_kos" value="{{ $aduanuppa->anggaran_kos }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('kos_terdahulu') is-invalid @enderror" id="kos_terdahulu" name="kos_terdahulu" value="{{ $aduanuppa->kos_terdahulu }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('syor_tindakan') is-invalid @enderror" id="syor_tindakan" name="syor_tindakan">{{ $aduanuppa->syor_tindakan }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <img src="{{ asset('storage/'.$aduanuppa->gambar) }}" width="50" height="100" alt="" class="rounded img-thumbnail">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="hidden" name="gambar_lama" value="{{ $aduanuppa->gambar }}">
                          <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="gambar" name="gambar" value="{{ $aduanuppa->gambar }}" >
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="date" class="form-control @error('tarikh_tindakan') is-invalid @enderror" id="tarikh_tindakan" name="tarikh_tindakan" value="{{ $aduanuppa->tarikh_tindakan }}">
