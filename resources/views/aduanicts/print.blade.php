...
<table cellspacing="9" cellpadding="0" style="width:100%">
	<tbody>
		<tr>
            ...
            <td style="width:65%">: {{ $aduanict->jenis_aset }}</td>
		</tr>
        <tr>
			<td>2.</td>
            <td>Nombor Siri Pendaftaran Aset/ Komponen</td>
            <td>: {{ $aduanict->no_siri }}</td>
		</tr>
        <tr>
			<td>3.</td>
        ...
        <tr>
            ...
            <td>: {{ $aduanict->perihal_kerosakan }}</td>
		</tr>
        <tr>
			<td>6.</td>
            <td>Nama dan Jawatan</td>
            <td>: {{ $aduanict->nama_pelapor }}/{{ $aduanict->jawatan_pelapor }}</td>
		</tr>
        <tr>
			<td>7.</td>
            <td>Tarikh</td>
...
<table cellspacing="9" cellpadding="0" style="width:100%">
	<tbody>
		<tr>
            ...
            <td>: RM {{ $aduanict->kos_terdahulu }}</td>
		</tr>
        <tr>
			<td>9.</td>
            <td style="width:40%">Anggaran Kos Penyelenggaraan</td>
            <td>: RM {{ $aduanict->anggaran_kos }}</td>
		</tr>
        <tr>
			<td>10.</td>
            <td>Syor Dan Ulasan</td>
            <td>: {{ $aduanict->syor_tindakan }}</td>
		</tr>
        <tr>
			<td>11.</td>
            <td>Nama Dan Jawatan</td>
            <td>: {{ $aduanict->nama_peg_aset}} <br />&nbsp; {{ $aduanict->jawatan_peg_aset }}</td>
		</tr>
        <tr>
			<td>12.</td>
            <td>Tarikh</td>
            <td>: {{ $aduanict->tarikh_tindakan }}</td>
		</tr>
	</tbody>
</table>
...
<section>
	<p>
		<span><small><i>** Untuk tujuan rekod UPSM ADTEC Kulim</i></small></span>
	</p>
	<p><strong>PERIHAL KEROSAKAN [ ] PERKAKASAN  [ ] RANGKAIAN [ ] PERISIAN</strong></p>
	<p>Status Tindakan ( Si Isi Oleh Penolong Pegawai Teknologi Maklumat )</p>

	<p>
		[ ] SELESAI <br>[ ] TIDAK SELESAI
	</p>
