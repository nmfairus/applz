...
<div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="{{ URL::to('ekjp/admin/create') }}" class="nav-link active">Pinda Kursus</a></li>
            </ul>
        </header>
    </div>
        ...
        <main class="form-signin w-100 m-auto">
            ...
            <form class="gelap text-start text-white" method="post" action="{{url('ekjp/admin')}}">
                ...
                <div class="input-group mb-3">
                    ...
                    <input value="{{ $viewData['kursus']}}{{ old('kursus') }}" name="kursus" type="text" class="form-control" placeholder="nama kursus" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Bidang Kursus</span>
                    <input value="{{ $viewData['bidang']}}{{ old('bidang') }}" name="bidang" type="text" class="form-control" placeholder="bidang kursus"
                        aria-label="Username" aria-describedby="basic-addon1">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Tempoh Kursus (Hari)</span>
                    <input value="{{ $viewData['tempoh']}}{{ old('tempoh') }}" name="tempoh" type="text" class="form-control" placeholder="tempoh kursus"
                        aria-label="Username" aria-describedby="basic-addon1">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input value="{{ $viewData['yuran']}}{{ old('yuran') }}" name="yuran" type="text" class="form-control" placeholder="yuran kursus"
                        aria-label="Username" aria-describedby="basic-addon1">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <textarea name="catatan" class="form-control" aria-label="With textarea">{{ $viewData['catatan']}}{{ old('catatan') }}</textarea>
                </div>
